...
<div class="data-form">	
	...
	<div id="dg-row" class="row">	
		<div class="col-md-4 col-xs-4">
			<div id="assurance_policy">
				<div class="title">능력 배양정책</div>
		...
		<div class="col-md-4 col-xs-4">
			<div id="training_needs">
				<div class="title">훈련 요구항목</div>
		...
		<div class="col-md-4 col-xs-4">
			<div id="training_record">
				<div class="title">훈련기록</div>
		...
		<div class="col-md-4 col-xs-4">
			<div id="iip">
				<div class="title" style="line-height:22px;">인력양성 프로그램 보유여부</div>
		...
		<div class="col-md-4 col-xs-4">
			<div id="ojt_time">
				<div class="title" style="line-height:22px;">직원별 내외부 교육 참가율</div>
		...
		<div class="col-md-8 col-xs-8">
			<div id="awarded">
				<div class="title" style="line-height:22px;">직원별 OJT 교육참가시간율</div>
